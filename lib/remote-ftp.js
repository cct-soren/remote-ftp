...
export default {
  ...
  activate(state) {
    ...
    this.client.onDidConnected(() => {
      this.treeView.root.name.setAttribute('data-name', Path.basename(this.client.root.remote));
      this.treeView.root.name.setAttribute('data-path', this.client.root.remote);
